...
public class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        Book book3 = givenBook("Study Book1");
        Book book4 = givenBook("Study Book2");
        ...
        BookAndAuthor bookAndAuthor4 = givenBookAndAuthor(book3, author2); // 공동저자
        BookAndAuthor bookAndAuthor5 = givenBookAndAuthor(book4, author1);
        BookAndAuthor bookAndAuthor6 = givenBookAndAuthor(book4, author2); // 공동저자
        ...
        author2.addBookAndAuthors(bookAndAuthor2, bookAndAuthor2, bookAndAuthor4, bookAndAuthor6);
